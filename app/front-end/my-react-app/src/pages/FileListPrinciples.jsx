...
const FileListPrinciples = () => {
  ...
  return (
    <div className="max-md:px-5 max-md:max-w-full w-full mx-auto">
      ...
      <div className="flex flex-col items-center px-4 md:px-8 lg:px-12 pt-5 pb-9 mt-8 w-full max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border border-solid border-neutral-300">
